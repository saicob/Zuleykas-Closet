...
const dbSettings = {
    user: 'sas',
    password: 'saicobi#',
    server: 'LAPTOP-D7T1S5MH',  //pongan el nombre de su servidor o la dirección IP si no funciona el nombre
    database: 'Zuleyka',  //usar EXEC xp_readerrorlog 0, 1, N'Server is listening on'; en MSSQL para ver el ip y el puerto que usa
